...
var newPart = part_type_create();
    ...
    part_type_sprite(newPart,spr_part_DustPuff,true,1,false);
    part_type_blend(newPart,false);
    part_type_size(newPart,1,1,0,0);
    part_type_life(newPart,room_speed/8, room_speed/3);
    part_type_orientation(newPart,0,0,0,0,0);
    part_type_gravity(newPart, 0, 0);
    part_type_speed(newPart, 0, 0, 0, 0);
    part_type_direction(newPart, 0, 0, 0, 0);
partLib[? "RunPuff"] = newPart;
