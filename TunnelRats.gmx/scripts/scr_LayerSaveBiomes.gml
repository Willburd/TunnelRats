/// scr_LayerSaveBiomes(worldName,UniverseNumber,layerNumber)
var worldName = argument0;
var universeNum = argument1;
var layNum = argument2;

var saveDir = working_directory + "/Worlds/" + string(worldName) + "/Universe" + string(universeNum ) + "/Chunks/LayerData_" + string(layNum) + ".dat";
